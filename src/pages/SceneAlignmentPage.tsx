    ...
    <div className="fixed inset-0 z-9999 text-white flex flex-col overflow-hidden" style={{ backgroundColor: '#09090b', zoom: ZOOM }}>
      ...
      <PageHeader
        ...
        actionMenuContent={(closeMenu) => (
          <>
            <button
              onClick={() => { setShowDebug(true); closeMenu(); }}
            ...
            >
              <Code2 className="w-4 h-4" /> Debug
            </button>
            <button
              onClick={() => { void onGenerateSceneAudio(slideIndex); closeMenu(); }}
            ...
            >
              ...
              {hasAudio ? 'Regenerate Scene TTS' : 'Generate Scene TTS'}
            </button>
          </>
        )}
        showHelp={false}
